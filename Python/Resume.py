...
#Lista Eager evaluation (evaluación anticipada): todos los elementos se generan y almacenan en memoria al instante.
#Puedes acceder a los elementos múltiples veces
#Ejemplo:
lista = [x * 2 for x in range(1000)]

#Generador
#Lazy evaluation (evaluación perezosa): los elementos se generan uno a uno cuando se necesitan, sin ocupar toda la memoria.
